...
class auto_generate_adv:
    ...
    # INPUT_IS_LIST = (False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, True )
    CATEGORY = "📂 SDVN/✨ Preset"
    RETURN_TYPES = ("IMAGE",)
    RETURN_NAMES = ("image",)
    FUNCTION = "auto_generate"
...
NODE_CLASS_MAPPINGS = {
    ...
    "SDVN Auto Generate Advance": auto_generate_adv,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "SDVN Auto Generate Advance": "💡 Auto Generate Advance",
